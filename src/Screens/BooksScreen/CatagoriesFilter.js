    ...
    return (
        <View style={{ width: windowWidth * 1.0, height: windowHeight * 1.0, backgroundColor: '#fff' }}>
            <View style={styles.headerBack}>
                ...
                <View>
                    <Text style={{ fontSize: 18, marginLeft: windowWidth * 0.04 }}>Catagory's Filter</Text>
                </View>
            </View>
                ...
                <View style={styles.superCheckContainer}>
                    <View style={styles.bothCheckAndRemmever}>
                        ...
                        <View style={{ alignSelf: 'center' }}>
                            <Text style={{ fontSize: 16, color: 'black' }}>Kids</Text>
                        </View>
                    </View>
                    <View style={styles.bothCheckAndRemmever}>
                        <CheckBox
                    ...
                    <View style={styles.bothCheckAndRemmever}>
                        ...
                        />
                        <View style={{ alignSelf: 'center' }}>
                            <Text style={{ fontSize: 16, color: 'black' }}>Cambridge</Text>
                        </View>
                    </View>
                    <View style={styles.bothCheckAndRemmever}>
                        <CheckBox
                        ...
                        />
                        <View style={{ alignSelf: 'center' }}>
                            <Text style={{ fontSize: 16, color: 'black' }}>University Press</Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
